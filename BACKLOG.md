...
- [ ] Indexed search backend (Zoekt) — sub-second full-codebase queries for large codebases (promoted from REQ-0041 FR-013) -> [requirements](docs/requirements/REQ-0044-indexed-search-backend-zoekt/)
