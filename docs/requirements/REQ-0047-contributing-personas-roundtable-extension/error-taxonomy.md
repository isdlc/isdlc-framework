...
| E3-003 | Info | No trigger matches found for any contributing persona | Propose only the 3 primaries + any `default_personas` |
...
|---------|---------------|-----------------|
| All user personas malformed | Only built-in personas available | Functionally identical to current behavior |
| Config file missing | Default verbosity (bulleted), no default personas | Clean defaults, no user impact |
| No trigger matches | Only 3 primaries proposed | User can still manually add personas |
