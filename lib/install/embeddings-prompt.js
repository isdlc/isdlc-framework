...
export function buildInitialEmbeddingsBlock() {
  return {
    ...
    // SimplifiedLayerNormFusion bug that crashes pipeline init at "all" on
    // Jina v2 fp16 CoreML. The parity test gates the flip; until it can
    // measure cosine parity, "disabled" is the fail-safe default (Article X).
